...
trait ApiResponseTrait
{
    ...
    {
        return $this->apiResponse(['success' => false, 'message' => $message, 200 , 'error_code' => 81]);
    }
    ...
    {
        return $this->respondError($message, 401,null,21);
    }
     ...
     * @return JsonResponse
     */
    protected function respondError($message, int $statusCode = 200, Exception $exception = null, int $error_code = 91)
    {
        return $this->apiResponse(
            [
                'success' => false,
    ...
    {
        return $this->respondError($message, 500,null,51);
    }
    ...
    {
        return $this->respondError($message, 404,null,52);
    }
